    ...
    <tbody>
      ...
      <?php foreach ($data_pengaduan as $dp) : ?>
        <tr>
          ...
          <?php if ($dp['status'] == '0') : ?>
            <td>
              <a href="<?= base_url('Masyarakat/PengaduanController/pengaduan_batal/'.$dp['id_pengaduan']) ?>" class="btn btn-sm btn-warning">Hapus</a>
            
              <a href="<?= base_url('Masyarakat/PengaduanController/edit/'.$dp['id_pengaduan']) ?>" class="btn btn-sm btn-info">Edit</a>
            </td>
